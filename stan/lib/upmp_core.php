...
require_once("../conf/upmp_config.php");
...
function buildSignature($req) {
	...
	//$prestr = $prestr.upmp_config::QSTRING_SPLIT.md5(upmp_config::$security_key);//$_SESSION['mid'];
	$prestr = $prestr.upmp_config::QSTRING_SPLIT.md5($_SESSION['mkey']);
	return md5($prestr);
}
