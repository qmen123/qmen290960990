...
class upmp_config
{
    ...
    static $mer_name                = "公号";//自添加的参数


    //static $mer_id     			= "880000000003149"; // 商户号
    //static $security_key    		= "6WcBQ6AnotuAmlP1n0s2rF5a9CPB1x2y"; // 商户密钥
    static $mer_back_end_url     	= "http://www.baidu.com";//后台通知地址
    static $mer_front_end_url     	= ""; // 前台通知地址

     static $upmp_trade_url   	 	= "http://202.101.25.178:8080/gateway/merchant/trade";//获取TN地址
     static $upmp_query_url    	    = "http://202.101.25.178:8080/gateway/merchant/query";//查询地址
